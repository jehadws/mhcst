        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4">
                <div className="flex flex-col gap-1">
                    ...
                    <p className="text-sm text-muted-foreground">{i.overview}</p>
                </div>
                            ...
                            <CardContent className="flex items-center justify-between p-5">
                                <div className="space-y-1.5">
                                    ...
                                    {card.delta !== null && card.delta !== undefined && (
                                        <p className={`flex items-center gap-1 text-xs font-medium ${card.delta >= 0 ? 'text-emerald-600 dark:text-emerald-400' : 'text-red-600 dark:text-red-400'}`}>
                        ...
                        <CardContent>
                            <ChartContainer config={enrollmentChartConfig} className="h-[260px] w-full">
                                <AreaChart data={enrollmentsByMonth} margin={{ left: 12, right: 12, top: 8 }}>
                                    ...
                                    <Area dataKey="value" type="natural" name="enrollments" stroke="var(--color-enrollments)" strokeWidth={2} fill="url(#fillEnrollments)" />
                                </AreaChart>
                            </ChartContainer>
                        </CardContent>
                    </Card>
                ...
                <div className="grid gap-4 lg:grid-cols-3">
                    <Card>
                        ...
                        <CardContent>
                            ...
                            {statusData.length === 0 && (
                                <p className="py-8 text-center text-sm text-muted-foreground">{i.noEnrollments}</p>
                            )}
                        </CardContent>
                    </Card>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <ChartContainer config={topCoursesConfig} className="h-[260px] w-full">
                                <BarChart data={topCourses} layout="vertical" margin={{ left: 8, right: 8, top: 8 }}>
                                    ...
                                    <YAxis type="category" dataKey="title" tickLine={false} axisLine={false} tickMargin={8} width={110} />
                                    <ChartTooltip cursor={false} content={<ChartTooltipContent />} />
                        ...
                        {recentEnrollments.length === 0 ? (
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-sm">
                                    <thead>
                                        <tr className="border-b text-left text-xs text-muted-foreground [&_th]:px-3 [&_th]:py-2">
