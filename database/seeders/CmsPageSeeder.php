    ...
    public function run(): void
    {
        $pages = [
            [
                'key' => 'about-us',
                'title' => 'عن الشركة',
                'content' => '<p>مستلي (Mset.ly) هي منصة رائدة في مجال التدريب المهني في ليبيا. نقدم دورات تدريبية عالية الجودة في مجالات متعددة بهدف تطوير المهارات ورفع كفاءة العمالة الوطنية.</p><p>رؤيتنا أن نكون الشريك الأول للأفراد والمؤسسات في رحلة التطوير المهني.</p>',
            ],
            [
                'key' => 'privacy-policy',
