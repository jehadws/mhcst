        ...
        dashboard: {
            sidebar: {
                ...
                items: {
                    ...
                    notificationLogs: 'Notification Log',
                },
            },
            leads: {
                status: {
                ...
                noSubject: 'Contact message',
                deleteTitle: 'Delete message',
                deleteDescription: 'Are you sure you want to delete this contact message?',
            },
            notificationLogs: {
                title: 'Notification log',
                description: 'Delivery history for automated emails (e.g. attendance alerts).',
                sent: 'Sent',
                failed: 'Failed',
                channelEmail: 'Email',
    ...
    ar: {
        dashboard: {
            ...
            leads: {
                ...
                noSubject: 'رسالة تواصل',
                deleteTitle: 'حذف الرسالة',
                deleteDescription: 'هل أنت متأكد من حذف رسالة التواصل هذه؟',
            },
            notificationLogs: {
                title: 'سجل الإشعارات',
                description: 'سجل إرسال الرسائل التلقائية (مثل تنبيهات الغياب).',
                sent: 'تم الإرسال',
                failed: 'فشل',
                channelEmail: 'بريد',
