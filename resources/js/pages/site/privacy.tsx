    ...
    <>
      ...
      <div className="flex min-h-screen flex-col">
        ...
        <main className="flex-1">
          <div className="border-border bg-secondary border-b py-12">
            <div className="mx-auto max-w-3xl px-4 text-center sm:px-6">
              ...
              <h1 className="text-foreground mt-4 font-serif text-3xl font-extrabold tracking-tight sm:text-4xl">
                {locale === 'ar' ? 'سياسة الخصوصية' : 'Privacy Policy'}
              </h1>
              <p className="text-muted-foreground mt-2 text-sm">{locale === 'ar' ? 'آخر تحديث: يناير 2025' : 'Last updated: January 2025'}</p>
            </div>
          </div>

          <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
            <div className="prose prose-lg dark:prose-invert prose-headings:font-serif prose-headings:font-bold prose-p:leading-relaxed prose-p:text-muted-foreground max-w-none">
              {locale === 'ar' ? (
                <>
                  <h2>مقدمة</h2>
                  <p>
                ...
                <>
                  ...
                  <p>
                    We may collect the following information when you register or contact us: full name, phone number, email address, and course
                    enrollment data.
                  </p>
                  <h2>How We Use Your Information</h2>
                  <p>
                    We use your information to process enrollment requests, communicate about programs and services, and improve your experience with
                    us.
                  </p>
                  <h2>Data Security</h2>
